...
<script>
  ...
  export default {
    ...
    methods: {
      getTableData() {
        //角色管理列表
        axios.get("/api/admin/role_index",
          {
            headers: {
      ...
      editClick(index, row) {
        ...
        this.mask = true;
        //展示权限显示
        axios.get("api/admin/role_create_show",
          {
            headers: {
              'Authorization': 'Bearer ' + this.token,
              'Accept': 'application/vnd.lingmo.v1+json'
        ...
        //角色编辑展示
        axios.get("api/admin/role_edit_show/" + row.id,
          {
            headers: {
              'Authorization': 'Bearer ' + this.token,
              'Accept': 'application/vnd.lingmo.v1+json'
      ...
      submission() {
        if (this.id) {
          ...
          axios.post("api/admin/role_edit",
            data,
            {
              headers: {
                'Authorization': 'Bearer ' + this.token,
          ...
          axios.post("api/admin/role_create",
            data,
            {
              headers: {
                'Authorization': 'Bearer ' + this.token,
      ...
      deleteClick(index, row) {
        //删除角色
        axios.get("api/admin/role_del/" + row.id,
          {
            headers: {
              'Authorization': 'Bearer ' + this.token,
              'Accept': 'application/vnd.lingmo.v1+json'
